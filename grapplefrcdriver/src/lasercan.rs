...
use crate::{can::GrappleCanDriver, with_err, COptional, JNIResultExtension};
...
impl NativeLaserCan {
    pub fn new(can_id: u8) -> Self {
        Self {
            driver: GrappleCanDriver::new(
                can_id,
                <GrappleDeviceMessage as HasTags>::Tags::DistanceSensor.to_tag(),
            ),
...
impl LaserCanImpl for NativeLaserCan {
    fn status(&mut self) -> Option<LaserCanStatusFrame> {
        self.driver.spin(&mut |_id, msg| match msg {
